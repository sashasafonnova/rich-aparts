...
const Header: React.FC = () => {
   ...
   const burgerOpen = useSelector((state: RootState) => state.menuSlice.burgerOpen);
      ...
      <header className={styles.header}>
         <div className="container">
            <nav className={styles.nav}>
               ...
               <button className={styles.menuBurgerBtn} onClick={() => dispatch(showMenuBurger(!burgerOpen))}>
